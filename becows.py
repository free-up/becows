import random
print('Игрок называет числа.\nЕсли цифра угадана и стоит на нужном месте, это «бык».\nЕсли цифра угадана, но стоит не на своём месте, это – «корова».\nОбратите внимание, что цифры могут повторяться; в этом случае корова может дублироваться и нередки случаи сообщения про 5 коров при четырехзначном числе.\n')
...
#E	print(one_dig) #проверочный вывод
			...
			#	print ("Бык")
				...
				for j in range(f):
					if one_dig[i] == digits[j]:
						#нужна проверка на копию коровы
...
print("Вы угадали за " + str(steps) + " ходов!")
